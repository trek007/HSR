...
$(document).ready(function () {
    ...
    $("[name='btnSave']").click(function () {
        if (validateSubmit()) {
            ...
            alert('No record selected or Region cannot be empty');
        }
    });
    ...
    function validateSubmit() {
        ...
        gridContentRows.each(function (index) {
            ...
            if (isRecordSelected) {
                ...
                var email = $(this).children().eq(GRID_Email_INDEX_Hidden).text();
                ...
                if (roles === OPTIONS.Region) {
                    ...
                    if (multiselect) {
                        ...
                        // Validated the empty region 01-09-2018
                        if (items.length === 0) {
                             selctedRecord = false;
